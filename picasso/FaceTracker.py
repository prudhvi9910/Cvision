...
class FaceDetector:
    """
    Detects the face in the live camera
    """
    def __init__(self, min_detect_conf=0.5):
        ...
        self.face = self.mpFace.FaceDetection(self.min_detect_conf) #Hands(self.mode, self.max_hands, self.min_detect_conf, self.min_track_conf)
